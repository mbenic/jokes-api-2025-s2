    ...
    <section class="py-6 mx-12 space-y-4">
        ...
        <nav class="flex flex-row justify-between">
            ...
            <div class="flex gap-6">
                ...
                <form action="{{ route('admin.jokes.index') }}"
                      name="searchForm"
            ...
            @forelse($jokes as $joke)
                <tr>
                    ...
                    <td class="p-2 pr-8 text-right border-b border-b-gray-400">
                        ...
                        {{ $joke->categories->count() }}
                    </td>
                    <td class="p-2 border-b border-b-gray-400">
                        <form
                           action="{{ route('admin.jokes.delete', $joke) }}"
                            class="grid grid-cols-3 gap-4"
                            method="POST">
                            @csrf
                            <x-link-primary-button
                                class="overflow-hidden justify-center"
                                href="{{ route('admin.jokes.show', $joke) }}">
                            ...
                            <x-link-primary-button
                                ...
                                href="{{ route('admin.jokes.edit', $joke) }}">
